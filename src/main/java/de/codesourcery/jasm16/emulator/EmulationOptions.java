...
public final class EmulationOptions {
    ...
    {
        List<IDcpuHardware> result = emulator.getDevicesByDescriptor( DefaultFloppyDrive.DESC );
        if ( result.isEmpty() ) {
    ...
    {
        List<IDcpuHardware> result = emulator.getDevicesByDescriptor( DefaultScreen.DESC );
        if ( result.isEmpty() ) {
    ...
    {
        List<IDcpuHardware> result = emulator.getDevicesByDescriptor( DefaultVectorDisplay.DEVICE_DESCRIPTOR );
        if ( result.isEmpty() ) {
    ...
    {
        List<IDcpuHardware> result = emulator.getDevicesByDescriptor( DefaultKeyboard.DESC );
        if ( result.isEmpty() ) {
