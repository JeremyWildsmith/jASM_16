...
public final class DefaultScreen implements IDcpuHardware {
	...
	/**
	 *
	 * @param mapVideoRamUponAddDevice whether to map video RAM to 0x8000 when
	 * afterAddDevice() is called
	 * @param mapFontRAMUponAddDevice whether to map font/glyph RAM to 0x8180
	...
	public BufferedImage getScreenImage() {
		final ConsoleScreen screen = this.consoleScreen;
